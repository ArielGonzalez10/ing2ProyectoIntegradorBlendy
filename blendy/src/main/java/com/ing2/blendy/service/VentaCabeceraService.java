...
import com.ing2.blendy.repository.IVentaCabeceraRepository;
 ...
 */
@Service
public class VentaCabeceraService implements IVentaCabeceraService{
    
    @Autowired
    private IVentaCabeceraRepository ventaCabeceraRepo;
